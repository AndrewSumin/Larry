...
l3234: {
l3185: {
/*3102*/switch(this["block"]) {
case "b-page":
/*3103*/switch(this["elem"]) {
case "favicon":
/*3104*/switch(this["_mode"]) {
case "attrs":
/*3105*/return ({"rel": "shortcut icon","href": this["ctx"]["url"]});return;; break;
case "tag":
break l3185;; break;
case "bem":
break l3725;; break;
...
break l3739;; break;
case "cls":
break l3739;; break;default: break l3742;}
; break;
case "js":
/*3141*/switch(this["_mode"]) {
case "attrs":
/*3142*/if((! this["ctx"]["url"]) === false) {
/*3143*/return ({"src": this["ctx"]["url"]});return;} else {
break l3739;}; break;
case "tag":
break l3724;; break;
case "bem":
...
; break;
case "css":
/*3182*/if((! this["ctx"]["url"]) === false) {
/*3183*/switch(this["_mode"]) {
case "attrs":
/*3184*/return ({"rel": "stylesheet","href": this["ctx"]["url"]});return;; break;
case "tag":
break l3185;; break;
case "bem":
break l3725;; break;
...
/*3228*/switch(this["_mode"]) {
case "attrs":
break l3739;; break;
case "tag":
/*3232*/return "style";return;; break;
case "bem":
break l3725;; break;
case "default":
break l3234;; break;
...
case "meta":
/*3275*/switch(this["_mode"]) {
case "attrs":
/*3276*/return this["ctx"]["attrs"];return;; break;
case "tag":
/*3277*/return "meta";return;; break;
case "bem":
break l3725;; break;
case "default":
break l3359;; break;
...
; break;
case "body":
/*3312*/switch(this["_mode"]) {
case "attrs":
break l3739;; break;
case "tag":
/*3316*/return "body";return;; break;
case "bem":
break l3739;; break;
case "default":
break l3359;; break;
...
; break;
case "head":
/*3353*/switch(this["_mode"]) {
case "attrs":
break l3739;; break;
case "tag":
/*3357*/return "head";return;; break;
case "bem":
break l3725;; break;
case "default":
break l3359;; break;
...
; break;
case "core":
break l3455;; break;default: break l3455;}
; break;
case "i-jquery":
/*3518*/switch(this["elem"]) {
case "favicon":
break l3778;; break;
case "js":
break l3778;; break;
...
break l3739;; break;
case "default":
/*3667*/{var __o31 = this,__v31 = __o31["_mode"];(__o31["_mode"]="");var __o32 = this,__v32 = __o32["ctx"];(__o32["ctx"]=({"block": "b-page","elem": "js","url": "//yandex.st/jquery/1.6.2/jquery.min.js"}));this.apply();(__o32["ctx"]=__v32);(__o31["_mode"]=__v31)};return;; break;
case "content":
break l3668;; break;
case "mix":
break l3739;; break;
...
case "cls":
break l3739;; break;default: break l3742;}
; break;default: break l3778;}
; break;
case "i-ua":
/*3719*/if((! (! this["elem"])) === false) {
/*3720*/switch(this["_mode"]) {
case "attrs":
break l3739;; break;
case "tag":
break l3724;; break;
...
break l3726;; break;
case "content":
/*3729*/return ["(function(d,e,c,r){","e=d.documentElement;","c=\"className\";","r=\"replace\";","e[c]=e[c][r](\"i-ua_js_no\",\"i-ua_js_yes\");","if(d.compatMode!=\"CSS1Compat\")","e[c]=e[c][r](\"i-ua_css_standard\",\"i-ua_css_quirks\")","})(document)"];return;; break;
case "mix":
break l3739;; break;
case "jsAttr":
break l3739;; break;
...
break l3778;}; break;default: break l3778;}
}/*3185*/return "link";return;}/*3234*/if((! this["ctx"].hasOwnProperty("ie")) === false) {
/*3235*/if((! (! this["ctx"]["_ieCommented"])) === false) {
...
break l3359;}} else {
break l3359;}}/*3359*/if((! (! this["elem"])) === false) {
break l3466;} else {
break l3726;}}/*3455*/if((! (! this["elem"])) === false) {
/*3456*/switch(this["_mode"]) {
case "attrs":
break l3739;; break;
case "tag":
break l3739;; break;
...
break l3778;}}/*3466*/{this["_buf"].push("<!DOCTYPE html>");{var __o34 = this,__v34 = __o34["_mode"];(__o34["_mode"]="");var __o35 = this,__v35 = __o35["ctx"];(__o35["ctx"]=({"tag": "html","attrs": ({"class": "i-ua_js_no i-ua_css_standard"}),"content": [({"elem": "head","content": [({"tag": "meta","attrs": ({"charset": "utf-8"})}),({"tag": "meta","attrs": ({"http-equiv": "X-UA-Compatible","content": "IE=EmulateIE7, IE=edge"})}),({"tag": "title","content": this["ctx"]["title"]}),(this["ctx"]["favicon"]?({"elem": "favicon","url": this["ctx"]["favicon"]}):""),this["ctx"]["meta"],({"block": "i-ua"}),this["ctx"]["head"]]}),({"elem": "body","mix": [this["ctx"]],"content": [this["ctx"]["content"]]})]}));this.apply();(__o35["ctx"]=__v35);(__o34["_mode"]=__v34)}};return;}/*3668*/if((! (! this["_start"])) === false) {
break l3779;} else {
break l3785;}}/*3724*/return "script";return;}/*3725*/return false;return;}/*3726*/if((! (! this["_start"])) === false) {
break l3779;} else {
break l3784;}}/*3739*/if((! (! this["_start"])) === false) {
break l3779;} else {
break l3789;}}/*3742*/if((! (! this["_start"])) === false) {
break l3779;} else {
break l3790;}}/*3778*/if((! (! this["_start"])) === false) {
break l3779;} else {
/*3780*/switch(this["_mode"]) {
case "attrs":
break l3789;; break;
case "tag":
break l3789;; break;
