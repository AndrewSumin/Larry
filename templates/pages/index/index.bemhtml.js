...
l2033: {
l1984: {
/*1901*/switch(this["block"]) {
case "b-page":
/*1902*/switch(this["elem"]) {
case "favicon":
/*1903*/switch(this["_mode"]) {
case "attrs":
/*1904*/return ({"rel": "shortcut icon","href": this["ctx"]["url"]});return;; break;
case "tag":
break l1984;; break;
case "bem":
break l2260;; break;
...
break l2274;; break;
case "cls":
break l2274;; break;default: break l2277;}
; break;
case "js":
/*1940*/switch(this["_mode"]) {
case "attrs":
/*1941*/if((! this["ctx"]["url"]) === false) {
/*1942*/return ({"src": this["ctx"]["url"]});return;} else {
break l2274;}; break;
case "tag":
break l2259;; break;
case "bem":
...
; break;
case "css":
/*1981*/if((! this["ctx"]["url"]) === false) {
/*1982*/switch(this["_mode"]) {
case "attrs":
/*1983*/return ({"rel": "stylesheet","href": this["ctx"]["url"]});return;; break;
case "tag":
break l1984;; break;
case "bem":
break l2260;; break;
...
/*2027*/switch(this["_mode"]) {
case "attrs":
break l2274;; break;
case "tag":
/*2031*/return "style";return;; break;
case "bem":
break l2260;; break;
case "default":
break l2033;; break;
...
case "meta":
/*2074*/switch(this["_mode"]) {
case "attrs":
/*2075*/return this["ctx"]["attrs"];return;; break;
case "tag":
/*2076*/return "meta";return;; break;
case "bem":
break l2260;; break;
case "default":
break l2158;; break;
...
; break;
case "body":
/*2111*/switch(this["_mode"]) {
case "attrs":
break l2274;; break;
case "tag":
/*2115*/return "body";return;; break;
case "bem":
break l2274;; break;
case "default":
break l2158;; break;
...
; break;
case "head":
/*2152*/switch(this["_mode"]) {
case "attrs":
break l2274;; break;
case "tag":
/*2156*/return "head";return;; break;
case "bem":
break l2260;; break;
case "default":
break l2158;; break;
...
case "cls":
break l2274;; break;default: break l2277;}
; break;default: /*2191*/if((! (! this["elem"])) === false) {
/*2192*/switch(this["_mode"]) {
case "attrs":
break l2274;; break;
case "tag":
break l2274;; break;
...
; break;
case "i-ua":
/*2254*/if((! (! this["elem"])) === false) {
/*2255*/switch(this["_mode"]) {
case "attrs":
break l2274;; break;
case "tag":
break l2259;; break;
...
break l2261;; break;
case "content":
/*2264*/return "document.documentElement.className=document.documentElement.className.replace(\"i-ua_js_no\", \"i-ua_js_yes\");if(document.compatMode!=\"CSS1Compat\")document.documentElement.className=document.documentElement.className.replace(\"i-ua_css_standart\", \"i-ua_css_quirks\");";return;; break;
case "mix":
break l2274;; break;
case "jsAttr":
break l2274;; break;
...
break l2313;}; break;default: break l2313;}
}/*1984*/return "link";return;}/*2033*/if((! this["ctx"].hasOwnProperty("ie")) === false) {
/*2034*/if((! (! this["ctx"]["_ieCommented"])) === false) {
/*2035*/{var hideRule = ((! this["ctx"]["ie"])?["gt IE 7","<!-->","<!--"]:[this["ctx"]["ie"],"",""]);{var __o34 = this,__v34 = __o34["_mode"];(__o34["_mode"]="");var __o35 = this["ctx"],__v35 = __o35["_ieCommented"];(__o35["_ieCommented"]=true);var __o36 = this,__v36 = __o36["ctx"];(__o36["ctx"]=[(("<!--[if " + hideRule[(0)]) + "]>"),hideRule[(1)],this["ctx"],hideRule[(2)],"<![endif]-->"]);this.apply();(__o36["ctx"]=__v36);(__o35["_ieCommented"]=__v35);(__o34["_mode"]=__v34)}};return;} else {
break l2158;}} else {
break l2158;}}/*2158*/if((! (! this["elem"])) === false) {
break l2202;} else {
break l2261;}}/*2202*/{this["_buf"].push("<!DOCTYPE html>");{var __o31 = this,__v31 = __o31["_mode"];(__o31["_mode"]="");var __o32 = this,__v32 = __o32["ctx"];(__o32["ctx"]=({"tag": "html","attrs": ({"class": "i-ua_js_no i-ua_css_standart"}),"content": [({"elem": "head","content": [({"tag": "meta","attrs": ({"http-equiv": "content-type","content": "text/html; charset=utf-8"})}),({"tag": "meta","attrs": ({"http-equiv": "X-UA-Compatible","content": "IE=EmulateIE7, IE=edge"})}),({"tag": "title","content": this["ctx"]["title"]}),(this["ctx"]["favicon"]?({"elem": "favicon","url": this["ctx"]["favicon"]}):""),this["ctx"]["meta"],({"block": "i-ua"}),this["ctx"]["head"]]}),({"elem": "body","mix": [this["ctx"]],"content": [this["ctx"]["content"]]})]}));this.apply();(__o32["ctx"]=__v32);(__o31["_mode"]=__v31)}};return;}/*2203*/if((! (! this["_start"])) === false) {
break l2314;} else {
break l2320;}}/*2259*/return "script";return;}/*2260*/return false;return;}/*2261*/if((! (! this["_start"])) === false) {
break l2314;} else {
break l2319;}}/*2274*/if((! (! this["_start"])) === false) {
break l2314;} else {
break l2324;}}/*2277*/if((! (! this["_start"])) === false) {
break l2314;} else {
break l2325;}}/*2313*/if((! (! this["_start"])) === false) {
break l2314;} else {
/*2315*/switch(this["_mode"]) {
case "attrs":
break l2324;; break;
case "tag":
break l2324;; break;
