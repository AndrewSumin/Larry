...
l7336: {
l6856: {
/*6815*/switch(this["block"]) {
case "message":
/*6816*/switch(this["elem"]) {
case "subject":
break l6856;; break;
case "from":
break l6856;; break;
...
break l7336;; break;
case "core":
break l7336;; break;default: break l7336;}
; break;
case "b-page":
/*7399*/switch(this["elem"]) {
case "subject":
break l7877;; break;
case "from":
break l7877;; break;
case "favicon":
/*7526*/switch(this["_mode"]) {
case "tag":
break l7606;; break;
case "attrs":
/*7528*/return ({"rel": "shortcut icon","href": this["ctx"]["url"]});return;; break;
case "bem":
break l8193;; break;
case "default":
break l7781;; break;
...
break l8207;; break;
case "cls":
break l8207;; break;default: break l8210;}
; break;
case "js":
/*7563*/switch(this["_mode"]) {
case "tag":
break l8189;; break;
case "attrs":
/*7565*/if((! this["ctx"]["url"]) === false) {
/*7566*/return ({"src": this["ctx"]["url"]});return;} else {
break l8207;}; break;
case "bem":
break l8193;; break;
case "default":
...
; break;
case "css":
/*7604*/if((! this["ctx"]["url"]) === false) {
/*7605*/switch(this["_mode"]) {
case "tag":
break l7606;; break;
case "attrs":
/*7607*/return ({"rel": "stylesheet","href": this["ctx"]["url"]});return;; break;
case "bem":
break l8193;; break;
case "default":
break l7656;; break;
...
/*7650*/switch(this["_mode"]) {
case "tag":
/*7651*/return "style";return;; break;
case "attrs":
break l8207;; break;
case "bem":
break l8193;; break;
...
case "meta":
/*7697*/switch(this["_mode"]) {
case "tag":
/*7698*/return "meta";return;; break;
case "attrs":
/*7699*/return this["ctx"]["attrs"];return;; break;
case "bem":
break l8193;; break;
case "default":
break l7781;; break;
...
; break;
case "body":
/*7734*/switch(this["_mode"]) {
case "tag":
/*7735*/return "body";return;; break;
case "attrs":
break l8207;; break;
case "bem":
break l8207;; break;
...
; break;
case "head":
/*7775*/switch(this["_mode"]) {
case "tag":
/*7776*/return "head";return;; break;
case "attrs":
break l8207;; break;
case "bem":
break l8193;; break;
...
; break;
case "core":
break l7877;; break;default: break l7877;}
; break;
case "i-jquery":
/*7940*/switch(this["elem"]) {
case "subject":
break l8246;; break;
case "from":
break l8246;; break;
...
break l8207;; break;
case "default":
/*8135*/{var __o31 = this,__v31 = __o31["_mode"];(__o31["_mode"]="");var __o32 = this,__v32 = __o32["ctx"];(__o32["ctx"]=({"block": "b-page","elem": "js","url": "//yandex.st/jquery/1.6.2/jquery.min.js"}));this.apply();(__o32["ctx"]=__v32);(__o31["_mode"]=__v31)};return;; break;
case "content":
break l8136;; break;
case "mix":
break l8207;; break;
...
case "cls":
break l8207;; break;default: break l8210;}
; break;default: break l8246;}
; break;
case "i-ua":
/*8187*/if((! (! this["elem"])) === false) {
/*8188*/switch(this["_mode"]) {
case "tag":
break l8189;; break;
case "attrs":
break l8207;; break;
...
break l8194;; break;
case "content":
/*8197*/return ["(function(d,e,c,r){","e=d.documentElement;","c=\"className\";","r=\"replace\";","e[c]=e[c][r](\"i-ua_js_no\",\"i-ua_js_yes\");","if(d.compatMode!=\"CSS1Compat\")","e[c]=e[c][r](\"i-ua_css_standard\",\"i-ua_css_quirks\")","})(document)"];return;; break;
case "mix":
break l8207;; break;
case "jsAttr":
break l8207;; break;
...
break l8246;}; break;default: break l8246;}
}/*6856*/switch(this["_mode"]) {
case "tag":
/*6857*/return "span";return;; break;
case "attrs":
break l8207;; break;
case "bem":
break l8207;; break;
...
case "cls":
break l8207;; break;default: break l8210;}
}/*7336*/if((! (! this["elem"])) === false) {
/*7337*/switch(this["_mode"]) {
case "tag":
/*7338*/return "div";return;; break;
case "attrs":
break l8207;; break;
case "bem":
break l8207;; break;
...
break l8246;}}/*7606*/return "link";return;}/*7656*/if((! this["ctx"].hasOwnProperty("ie")) === false) {
/*7657*/if((! (! this["ctx"]["_ieCommented"])) === false) {
...
break l7781;}} else {
break l7781;}}/*7781*/if((! (! this["elem"])) === false) {
break l7888;} else {
break l8194;}}/*7877*/if((! (! this["elem"])) === false) {
/*7878*/switch(this["_mode"]) {
case "tag":
break l8207;; break;
case "attrs":
break l8207;; break;
...
break l8246;}}/*7888*/{this["_buf"].push("<!DOCTYPE html>");{var __o34 = this,__v34 = __o34["_mode"];(__o34["_mode"]="");var __o35 = this,__v35 = __o35["ctx"];(__o35["ctx"]=({"tag": "html","attrs": ({"class": "i-ua_js_no i-ua_css_standard"}),"content": [({"elem": "head","content": [({"tag": "meta","attrs": ({"charset": "utf-8"})}),({"tag": "meta","attrs": ({"http-equiv": "X-UA-Compatible","content": "IE=EmulateIE7, IE=edge"})}),({"tag": "title","content": this["ctx"]["title"]}),(this["ctx"]["favicon"]?({"elem": "favicon","url": this["ctx"]["favicon"]}):""),this["ctx"]["meta"],({"block": "i-ua"}),this["ctx"]["head"]]}),({"elem": "body","mix": [this["ctx"]],"content": [this["ctx"]["content"]]})]}));this.apply();(__o35["ctx"]=__v35);(__o34["_mode"]=__v34)}};return;}/*8136*/if((! (! this["_start"])) === false) {
break l8247;} else {
break l8253;}}/*8189*/return "script";return;}/*8193*/return false;return;}/*8194*/if((! (! this["_start"])) === false) {
break l8247;} else {
break l8252;}}/*8207*/if((! (! this["_start"])) === false) {
break l8247;} else {
break l8257;}}/*8210*/if((! (! this["_start"])) === false) {
break l8247;} else {
break l8258;}}/*8246*/if((! (! this["_start"])) === false) {
break l8247;} else {
/*8248*/switch(this["_mode"]) {
case "tag":
break l8257;; break;
case "attrs":
break l8257;; break;
...
break l8268;}}}}} else {
break l8268;}}/*8268*/throw true;return;};